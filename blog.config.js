...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Max', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通人，躺又躺不平，卷有卷不过。。。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.starrain.vip', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京ICP备2024094132号-1', // 备案号 闽ICP备XXXXXX
